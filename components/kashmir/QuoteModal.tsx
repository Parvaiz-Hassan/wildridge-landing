...
// ---------------------------------------------------------------------------
// Small inline icons (no icon library installed — hand-rolled SVGs keep the
// popup dependency-free). All are 24x24 outline style, colored via
// currentColor so they pick up whatever text color class is applied.
// ---------------------------------------------------------------------------
